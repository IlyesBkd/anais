...
const Serbia = () => {
  ...
  const handleCtaClick = () => {
    ...
    // Lien d'affiliation pour la page /serbia
    window.location.href = "https://afflat3d3.com/trk/lnk/895E33EB-DA15-472C-9258-4221C5BE41C1/?o=28224&c=918273&a=277245&k=578AC6CCBA91C68601950B50135B7711&l=30960&s1=serbia";
  };
      ...
      <div className="w-full max-w-sm md:max-w-xl mx-auto">
        ...
        <div className="text-center mb-2 md:mb-5">
          <Badge className="bg-yellow-400 text-black font-bold text-xs md:text-sm px-2 md:px-5 py-1 md:py-2">
            ...
            EKSKLUZIVNA PONUDA - OGRANIČENO VREME
          </Badge>
        </div>
        ...
        <div className="text-center mb-3 md:mb-6">
          <h1 className="text-xl md:text-4xl lg:text-5xl font-bold text-white mb-1 md:mb-3">
            Zaradite do <span className="text-yellow-300">720 RSD</span> po anketi !
          </h1>
          <p className="text-blue-100 text-sm md:text-xl">
            Pridružite se članovima koji zarađuju do <span className="text-yellow-300 font-bold">18 000 RSD</span> mesečno
          </p>
        </div>
          ...
          <div className="text-center space-y-2 md:space-y-5">
            ...
            <div className="grid grid-cols-3 gap-1 md:gap-5 mb-2 md:mb-5">
              <div className="text-center">
                <div className="text-base md:text-2xl lg:text-3xl font-bold text-green-600">720 RSD</div>
                <div className="text-xs md:text-sm text-gray-600">Po anketi</div>
              </div>
              <div className="text-center">
                <div className="text-base md:text-2xl lg:text-3xl font-bold text-blue-600">15min</div>
                <div className="text-xs md:text-sm text-gray-600">Prosečno vreme</div>
              </div>
              <div className="text-center">
                <div className="text-base md:text-2xl lg:text-3xl font-bold text-purple-600">24h</div>
                <div className="text-xs md:text-sm text-gray-600">Isplata</div>
              </div>
            </div>
            ...
            <div className="space-y-1 md:space-y-3 mb-2 md:mb-5">
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <span className="text-gray-700 text-xs md:text-base lg:text-lg">Ankete dostupne 24/7</span>
              </div>
              <div className="flex items-center gap-2 md:gap-3">
                <Check className="w-3 h-3 md:w-5 md:h-5 lg:w-6 lg:h-6 text-green-500 flex-shrink-0" />
                <span className="text-gray-700 text-xs md:text-base lg:text-lg">Amazon, PayPal, bankovni transfer</span>
              </div>
              <div className="flex items-center gap-2 md:gap-3">
                <Check className="w-3 h-3 md:w-5 md:h-5 lg:w-6 lg:h-6 text-green-500 flex-shrink-0" />
                <span className="text-gray-700 text-xs md:text-base lg:text-lg">Bez skrivenih troškova</span>
              </div>
              <div className="flex items-center gap-2 md:gap-3">
                <Check className="w-3 h-3 md:w-5 md:h-5 lg:w-6 lg:h-6 text-green-500 flex-shrink-0" />
                <span className="text-gray-700 text-xs md:text-base lg:text-lg">24/7 korisnička podrška</span>
              </div>
            </div>
        ...
        <div className="text-center space-y-1 md:space-y-4">
          ...
          <div className="flex items-center justify-center gap-1 md:gap-3 text-white">
            ...
            <span className="text-blue-200 text-xs md:text-sm lg:text-base">(2,847 recenzija)</span>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-6 text-blue-200 text-xs md:text-sm lg:text-base">
            <div className="flex items-center gap-1 md:gap-2 lg:gap-2">
              ...
              <span>+15,000 srpskih članova</span>
            </div>
            <div className="flex items-center gap-1 md:gap-2 lg:gap-2">
              <TrendingUp className="w-2 h-2 md:w-4 md:h-4 lg:w-5 lg:h-5" />
              <span>Garancija zarade</span>
            </div>
          </div>

          {/* Disclaimer */}
          <p className="text-xs md:text-xs lg:text-sm text-blue-200/80">
            * Individualni rezultati se mogu razlikovati. Ograničena vremenska ponuda samo za nove članove.
          </p>
        </div>
      </div>
    </div>
