...
const OnlineJobs = () => {
  ...
  const handleCtaClick = () => {
    ...
    // Lien d'affiliation pour la page /online-jobs avec suivi Google Ads
    if (typeof (window as any).gtag_report_conversion === 'function') {
      (window as any).gtag_report_conversion("https://afflat3d2.com/trk/lnk/895E33EB-DA15-472C-9258-4221C5BE41C1/?o=28224&c=918273&a=277245&k=578AC6CCBA91C68601950B50135B7711&l=30960&s1=online-jobs");
    } else {
      window.location.href = "https://afflat3d2.com/trk/lnk/895E33EB-DA15-472C-9258-4221C5BE41C1/?o=28224&c=918273&a=277245&k=578AC6CCBA91C68601950B50135B7711&l=30960&s1=online-jobs";
    }
  };
