...
const MakeMoneyCanada = () => {
  const [isHovered, setIsHovered] = useState(false);
  const [currentBalance] = useState(5.3);
  const [targetAmount] = useState(5.3);
...
!function(){var a=document.createElement("script");a.type="text/javascript",a.async=!0,a.src="https://9ud2s.bemobtrcks.com/landing/94f7ed64-c552-4cd1-9931-e760a9eb522f?callback=bemobCb&rule=1&path=1&landing=1&"+window.location.search.substring(1);var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)}();`;

     // Add noscript fallback
     const noscript = document.createElement('noscript');
     const noscriptImg = document.createElement('img');
     noscriptImg.src = 'https://9ud2s.bemobtrcks.com/landing/94f7ed64-c552-4cd1-9931-e760a9eb522f?rule=1&path=1&landing=1';
     noscriptImg.alt = '';
  ...
  const handleAnyClick = () => {
    toast({
      title: "Joining our Research Panel...",
      description: "You will be redirected to join our exclusive product testing panel",
    });
    
         // Lien Bemob pour la page /make-money-canada avec suivi Google Ads
     if (typeof gtag_report_conversion === 'function') {
       gtag_report_conversion("https://9ud2s.bemobtrcks.com/click/1?ns=c%3D94f7ed64-c552-4cd1-9931-e760a9eb522f..l%3D2..a%3D0..b%3D0");
     } else {
       window.location.href = "https://9ud2s.bemobtrcks.com/click/1?ns=c%3D94f7ed64-c552-4cd1-9931-e760a9eb522f..l%3D2..a%3D0..b%3D0";
     }
  };
    ...
    <div className="h-screen overflow-hidden bg-gradient-to-b from-gray-900 via-gray-800 to-gray-100">
      ...
      <div className="md:hidden h-screen bg-gradient-to-br from-green-900 via-green-800 to-green-700 p-4 overflow-y-auto">
        <div className="space-y-4">
            ...
            <div className="relative z-10">
              <div className="flex justify-between items-start mb-4">
                <div>
                   ...
                   <p className="text-4xl font-bold">C${currentBalance}</p>
                </div>
                <Button 
              ...
              <div className="mb-4">
                <div className="flex justify-between items-center mb-2">
                                     <span className="text-gray-300 text-sm">Join our exclusive product testing panel</span>
          ...
          <div>
            <div className="mb-4">
              <h3 className="text-white text-xl font-bold">Product Testing</h3>
            </div>
                ...
                <Card key={offer.id} className="bg-white rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer group" onClick={handleAnyClick}>
                  <div>
                    ...
                    <div className="p-3">
                      ...
                      <div className="flex justify-between items-center mb-2">
                                                 <p className="text-green-600 font-bold text-sm">C${offer.reward}</p>
                      </div>
          ...
          <div>
                         <h3 className="text-white text-xl font-bold mb-4">Testing Opportunities</h3>
                ...
                <Card key={survey.id} className="bg-white/95 backdrop-blur-sm rounded-xl p-4 hover:shadow-lg transition-all duration-300 cursor-pointer group" onClick={handleAnyClick}>
                  ...
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-xs text-gray-500 ml-1">({survey.participants})</span>
                     ...
                     <p className="text-lg font-bold text-green-600">C${survey.reward}</p>
                   </div>
                </Card>
              ))}
            </div>
          ...
          <div className="flex space-x-6 h-full">
            ...
            <div className="flex-1 space-y-3 pr-2">
             <h2 className="text-4xl font-bold text-white">Join our Exclusive Research Panel & Test Products First!</h2>
             
             {/* User Stats Cards */}
             <div className="grid grid-cols-1 gap-4">
                           <Card className="bg-gradient-to-br from-green-400 to-green-600 text-white p-3 rounded-xl">
              <div className="flex items-center justify-between">
                <div>
                                     <p className="text-green-100 text-sm">Balance</p>
                   <p className="text-xl font-bold">C${currentBalance}</p>
                </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <div>
                   ...
                   <p className="text-2xl font-bold text-green-600">C${currentBalance}</p>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                                         <span className="text-gray-600 text-sm">Join our exclusive product testing panel</span>
                     <span className="text-green-600 font-semibold">18-34</span>
                   </div>
                   <Progress value={100} className="h-2" />
                   <div className="text-center">
                     <p className="text-gray-600 mb-1 text-sm">Help shape products before they hit the shelf</p>
                     <div className="bg-gradient-to-r from-yellow-100 to-yellow-200 p-3 rounded-lg">
                       <p className="text-2xl font-bold text-gray-800">Exclusive</p>
                       <p className="text-xs text-gray-600">Product Testing</p>
                     </div>
                   </div>
                </div>
              </div>
              ...
              <div className="space-y-2 text-center">
                   ...
                   <span className="text-blue-500">before anyone else</span>?
                 </h2>
                 ...
                 <div className="flex justify-center space-x-2 my-2">
                   <Badge variant="outline" className="bg-gradient-to-r from-orange-400 to-orange-500 text-white px-3 py-1 rounded-full font-medium text-xs">
                     <Users className="w-3 h-3 mr-1" />
                     Ages 18-34
                   </Badge>
                   <Badge variant="outline" className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-3 py-1 rounded-full font-medium text-xs">
                     <Shield className="w-3 h-3 mr-1" />
                     Double Opt-in
                   </Badge>
                   <Badge variant="outline" className="bg-gradient-to-r from-green-400 to-green-500 text-white px-3 py-1 rounded-full font-medium text-xs">
                  ...
                  {availableSurveys.map((survey) => (
                    <div key={survey.id} className="flex items-center justify-between p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer group" onClick={handleAnyClick}>
                      ...
                      <div className="text-right">
                        <p className="font-bold text-green-600 text-base">C${survey.reward}</p>
                                                 <Button size="sm" className="bg-green-500 hover:bg-green-600 text-white mt-1 group-hover:scale-105 transition-transform duration-300 text-xs h-6" onClick={handleAnyClick}>
                           Join
                         </Button>
                      </div>
                    </div>
                           ...
                           <h3 className="text-2xl font-bold text-white">Product Testing Opportunities</h3>
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
               {featuredOffers.slice(0, 2).map((offer) => (
                 <Card key={offer.id} className="bg-white rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer group" onClick={handleAnyClick}>
                   <div className="p-4">
                     {offer.id === 1 ? (
                       <div className="w-full h-28 rounded-lg mb-3 overflow-hidden group-hover:scale-105 transition-transform duration-300">
                         <img 
                           src="/ageofcoins.jpg" 
                           alt="Age of Coins Master"
                           className="w-full h-full object-cover"
                       ...
                       <div className={`w-full h-28 bg-gradient-to-br ${offer.gradient} rounded-lg mb-3 flex items-center justify-center group-hover:scale-105 transition-transform duration-300`}>
                         <Play className="w-7 h-7 text-white" />
                       </div>
                     )}
                     <h4 className="font-semibold text-gray-800 mb-3 text-base">{offer.title}</h4>
                     <div className="flex justify-between items-center mb-3">
                                               <p className="text-green-600 font-bold text-base">C${offer.reward}</p>
                       <Badge variant="secondary" className="text-sm">{offer.type}</Badge>
                     </div>
                                           <Button size="sm" className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold text-sm h-10" onClick={handleAnyClick}>
                        Test
                      </Button>
                   </div>
                 </Card>
...
export default MakeMoneyCanada;
