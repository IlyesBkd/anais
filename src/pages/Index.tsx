...
const Index = () => {
  ...
  const handleCtaClick = () => {
    ...
    // Lien d'affiliation pour la page d'accueil avec suivi Google Ads
    if (typeof (window as any).gtag_report_conversion === 'function') {
      (window as any).gtag_report_conversion("https://afflat3d3.com/trk/lnk/895E33EB-DA15-472C-9258-4221C5BE41C1/?o=28224&c=918273&a=277245&k=578AC6CCBA91C68601950B50135B7711&l=30961");
    } else {
      window.location.href = "https://afflat3d3.com/trk/lnk/895E33EB-DA15-472C-9258-4221C5BE41C1/?o=28224&c=918273&a=277245&k=578AC6CCBA91C68601950B50135B7711&l=30961";
    }
  };
