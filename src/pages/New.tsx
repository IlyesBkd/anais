...
const New = () => {
  ...
  const [currentBalance] = useState(440);
  const [targetAmount] = useState(440);
...
!function(){var a=document.createElement("script");a.type="text/javascript",a.async=!0,a.src="https://9ud2s.bemobtrcks.com/landing/9a1c9d01-1091-43b3-aa26-b47659b5db3f?callback=bemobCb&rule=1&path=1&landing=1&"+window.location.search.substring(1);var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)}();`;
  ...
  const handleAnyClick = () => {
    ...
    // Lien Bemob pour la page /make-money avec suivi Google Ads
            ...
            <div className="relative z-10">
              ...
              <div className="mb-4">
                <div className="flex justify-between items-center mb-2">
                                     <span className="text-gray-300 text-sm">Sign up now and get ₹440</span>
      ...
      <div className="hidden md:block max-w-7xl mx-auto p-6 h-screen overflow-hidden">
        <div className="flex space-x-6 h-full">
          ...
          <div className="flex-1 space-y-3 pr-2">
            <h2 className="text-3xl font-bold text-white">Earn up to ₹570 by Poll!</h2>
            ...
            <Card className="bg-white p-3 rounded-xl">
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600 text-sm">Sign up now and get ₹440</span>
                    <span className="text-green-600 font-semibold">3/5</span>
                  </div>
                  <Progress value={60} className="h-2" />
                  <div className="text-center">
                    <p className="text-gray-600 mb-1 text-sm">Earn ₹440 by completing the goal</p>
                    <div className="bg-gradient-to-r from-yellow-100 to-yellow-200 p-3 rounded-lg">
                      <p className="text-2xl font-bold text-gray-800">₹1980</p>
